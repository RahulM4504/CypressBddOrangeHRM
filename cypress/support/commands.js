...
Cypress.Commands.add("edit_user_job_details_firstemployee",()=>
    ...
    Cypress.Commands.add("hover_mouse",()=>
    {
     ...
     Cypress.Commands.add("PerformanceTracker",()=>
     {
       ...
       cy.get("select[name='addPerformanceTracker[availableEmp][]']").select(['David Morris','Manish Bhatia']);
       cy.get("#btnAssignEmployee").click();
       cy.get("select[name='addPerformanceTracker[assignedEmp][]']").contains('option','David Morris','Manish Bhatia');
       cy.save_details();
     })
